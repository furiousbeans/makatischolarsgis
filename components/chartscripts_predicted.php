<script>
        ...
        async function getCSV(){
            // scholar type a
            var response1 = await fetch("../assets/data/scholars/predicted_scholar_a.csv")
            ...
            table1.forEach(row =>{
                var columns = row.split(',');
                var year=columns[0];
                var bangkal_a1=columns[1];
                var belair_a1=columns[2];
                var carmona_a1=columns[3];
                var cembo_a1=columns[4];
                var comembo_a1=columns[5];
                var dasmarinas_a1=columns[6];
                var eastrembo_a1=columns[7];
                var forbespark_a1=columns[8];
                var guadalupenuevo_a1=columns[9];
                var guadalupeviejo_a1=columns[10];
                var kasilawan_a1=columns[11];
                var lapaz_a1=columns[12];
                var magallanes_a1=columns[13];
                var olympia_a1=columns[14];
                var palanan_a1=columns[15];
                var pembo_a1=columns[16];
                var pinagkaisahan_a1=columns[17];
                var pio_a1=columns[18];
                var pitogo_a1 = columns[19];
                var poblacion_a1 = columns[20];
                var ppnorth_a1 = columns[21];
                var ppsouth_a1 = columns[22];
                var rizal_a1 = columns[23];
                var sanantonio_a1 = columns[24];
                var sanisidro_a1 = columns[25];
                var sanlorenzo_a1 = columns[26];
                var santacruz_a1 = columns[27];
                var singkamas_a1 = columns[28];
                var southcembo_a1 = columns[29];
                var tejeros_a1 = columns[30];
                var urdaneta_a1 = columns[31];
                var valenzuela_a1 = columns[32];
                var westrembo_a1 = columns[33];
            ...
            // scholar type a
            var response1 = await fetch("../assets/data/scholars/predicted_scholar_b.csv")
            var data1 = await response1.text();
            ...
            table1.forEach(row =>{
                var columns = row.split(',');
                var year=columns[0];
                var bangkal_b1=columns[1];
                var belair_b1=columns[2];
                var carmona_b1=columns[3];
                var cembo_b1=columns[4];
                var comembo_b1=columns[5];
                var dasmarinas_b1=columns[6];
                var eastrembo_b1=columns[7];
                var forbespark_b1=columns[8];
                var guadalupenuevo_b1=columns[9];
                var guadalupeviejo_b1=columns[10];
                var kasilawan_b1=columns[11];
                var lapaz_b1=columns[12];
                var magallanes_b1=columns[13];
                var olympia_b1=columns[14];
                var palanan_b1=columns[15];
                var pembo_b1=columns[16];
                var pinagkaisahan_b1=columns[17];
                var pio_b1=columns[18];
                var pitogo_b1 = columns[19];
                var poblacion_b1 = columns[20];
                var ppnorth_b1 = columns[21];
                var ppsouth_b1 = columns[22];
                var rizal_b1 = columns[23];
                var sanantonio_b1 = columns[24];
                var sanisidro_b1 = columns[25];
                var sanlorenzo_b1 = columns[26];
                var santacruz_b1 = columns[27];
                var singkamas_b1 = columns[28];
                var southcembo_b1 = columns[29];
                var tejeros_b1 = columns[30];
                var urdaneta_b1 = columns[31];
                var valenzuela_b1 = columns[32];
                var westrembo_b1 = columns[33];
                // console.log(row);
                // console.log(year,brg1,brg2,brg3,brg4,brg5)
            ...
            // scholar type a
            var response1 = await fetch("../assets/data/scholars/predicted_scholar_c.csv")
            var data1 = await response1.text();
